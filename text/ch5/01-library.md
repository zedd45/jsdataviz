...
The [Chronoline.js](http://stoicloofah.github.io/chronoline.js/) library works like most of the other JavaScript libraries we’ve used in the book. You include the library in your page, define your data, and let the library create the visualization.
